...
// Imported Components with Lazy Loading
const MySpecialities = dynamic(() => import("./MySpecialities"));
const MyWork = dynamic(() => import("./MyWork"));
...
export default function Home() {
  ...
  const structuredData = {
    ...
    "@id": "https://lilac-clone-seven.vercel.app",
    name: "Dr. Maya Reynolds, PsyD - Clinical Psychologist",
    image: "https://lilac-clone-seven.vercel.app/hero.png",
    description:
      "Licensed clinical psychologist in Santa Monica, CA specializing in anxiety therapy, trauma treatment, PTSD, and burnout. Offering evidence-based CBT, EMDR, and mindfulness therapy for adults.",
    url: "https://lilac-clone-seven.vercel.app",
  ...
  return (
    <>
      <Head>
        {/* Primary Meta Tags */}
        <title>
          Dr. Maya Reynolds, PsyD | Anxiety & Trauma Therapy Santa Monica, CA
        </title>
        <meta
          name="title"
          content="Dr. Maya Reynolds, PsyD | Anxiety & Trauma Therapy Santa Monica, CA"
        />
        <meta
          name="description"
          content="Licensed clinical psychologist in Santa Monica offering evidence-based therapy for anxiety, trauma, PTSD, and burnout. CBT, EMDR, and telehealth sessions across California."
        />
        <meta
          name="keywords"
          content="psychologist Santa Monica, anxiety therapy California, trauma therapist, EMDR therapy, burnout treatment, telehealth therapy California, licensed clinical psychologist, CBT therapy, PTSD treatment, panic disorder therapy"
        />
        <meta name="author" content="Dr. Maya Reynolds, PsyD" />
        <meta name="viewport" content="width=device-width, initial-scale=1.0" />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://lilac-clone-seven.vercel.app" />

        {/* Open Graph / Facebook */}
        <meta property="og:type" content="website" />
        <meta
          property="og:url"
          content="https://lilac-clone-seven.vercel.app"
        />
        <meta
          property="og:title"
          content="Dr. Maya Reynolds | Clinical Psychologist Santa Monica"
        />
        <meta
          property="og:description"
          content="Compassionate, evidence-based therapy for anxiety, trauma, and burnout in Santa Monica, CA. In-person and telehealth sessions available."
        />
        <meta
          property="og:image"
          content="https://lilac-clone-seven.vercel.app/hero.png"
        />
        ...
        <meta
          ...
          content="Compassionate, evidence-based therapy for anxiety, trauma, and burnout in Santa Monica, CA."
        />
        <meta
        ...
        {/* Contact Information */}
        <meta name="contact" content="contact@drmayareynolds.com" />
        <meta name="telephone" content="+1-310-555-1234" />
        <meta
          name="address"
          content="123th Street 45 W, Santa Monica, CA 90401"
        />
          ...
          <div className="mx-auto max-w-[1500px] grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 w-full">
            ...
            <div className="order-1 md:order-2 flex items-center">
              <div className="w-full max-w-[560px] flex flex-col items-center text-center">
                ...
                >
                  A thoughtful, supportive approach for adults feeling
                  overwhelmed by stress, past experiences, or high internal
                  pressure.
                </motion.p>
                ...
                >
                  <motion.a
                    ...
                    animate="rest"
                    whileHover="hover"
                    className="relative inline-flex items-center justify-center overflow-hidden border-2 border-[#4A7C7E] px-6 sm:px-7 md:px-8 py-3 sm:py-3.5 md:py-4 font-semibold text-sm sm:text-base tracking-wide text-[#4A7C7E]"
                  >
                    <motion.span
                      variants={{
